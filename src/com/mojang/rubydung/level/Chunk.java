...
public class Chunk {
	public com.mojang.rubydung.phys.AABB aabb;
	...
	private int lists = -1;
	private static int texture = com.mojang.rubydung.Textures.loadTexture(
			"/terrain.png", 9728);
	...
	public Chunk(Level level, int x0, int y0, int z0, int x1, int y1, int z1) {
		...
		aabb = new com.mojang.rubydung.phys.AABB(x0, y0, z0, x1, y1, z1);
