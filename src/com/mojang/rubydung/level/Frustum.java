...
public class Frustum {
	...
	private void calculateFrustum() {
		...
		clip[5] = (modl[4] * proj[1] + modl[5] * proj[5] + modl[6] * proj[9] + modl[7]
				* proj[13]);
		clip[6] = (modl[4] * proj[2] + modl[5] * proj[6] + modl[6] * proj[10] + modl[7]
				* proj[14]);
		clip[7] = (modl[4] * proj[3] + modl[5] * proj[7] + modl[6] * proj[11] + modl[7]
				* proj[15]);

		clip[8] = (modl[8] * proj[0] + modl[9] * proj[4] + modl[10] * proj[8] + modl[11]
				* proj[12]);
		clip[9] = (modl[8] * proj[1] + modl[9] * proj[5] + modl[10] * proj[9] + modl[11]
				* proj[13]);
		clip[10] = (modl[8] * proj[2] + modl[9] * proj[6] + modl[10] * proj[10] + modl[11]
				* proj[14]);
		clip[11] = (modl[8] * proj[3] + modl[9] * proj[7] + modl[10] * proj[11] + modl[11]
				* proj[15]);
	...
	public boolean cubeFullyInFrustum(float x1, float y1, float z1, float x2,
			float y2, float z2) {
		for (int i = 0; i < 6; i++) {
			if (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y1 + m_Frustum[i][2]
					* z1 + m_Frustum[i][3] <= 0.0F)
				return false;
			if (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y1 + m_Frustum[i][2]
					* z1 + m_Frustum[i][3] <= 0.0F)
				return false;
			if (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y2 + m_Frustum[i][2]
					* z1 + m_Frustum[i][3] <= 0.0F)
				return false;
			if (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y2 + m_Frustum[i][2]
					* z1 + m_Frustum[i][3] <= 0.0F)
				return false;
			if (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y1 + m_Frustum[i][2]
					* z2 + m_Frustum[i][3] <= 0.0F)
				return false;
			if (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y1 + m_Frustum[i][2]
					* z2 + m_Frustum[i][3] <= 0.0F)
				return false;
	...
	public boolean cubeInFrustum(float x1, float y1, float z1, float x2,
		...
		for (int i = 0; i < 6; i++) {
			if ((m_Frustum[i][0] * x1 + m_Frustum[i][1] * y1 + m_Frustum[i][2]
					* z1 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y1
							+ m_Frustum[i][2] * z1 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y2
							+ m_Frustum[i][2] * z1 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y2
							+ m_Frustum[i][2] * z1 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y1
							+ m_Frustum[i][2] * z2 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x2 + m_Frustum[i][1] * y1
							+ m_Frustum[i][2] * z2 + m_Frustum[i][3] <= 0.0F)
					&& (m_Frustum[i][0] * x1 + m_Frustum[i][1] * y2
							+ m_Frustum[i][2] * z2 + m_Frustum[i][3] <= 0.0F)
